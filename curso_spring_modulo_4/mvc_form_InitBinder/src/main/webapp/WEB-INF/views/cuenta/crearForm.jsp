...
<body>
	...
	<div class="container">
		<div class="page-header">
			<h1>Ejemplo InitBinder y Validación Anotaciones <small>ingrese una fecha renovación en el formato yyyy-MM-dd, también ingrese el nombre en minúscula el cual posteriormente será convertido en mayúscula</small>
			</h1>
		</div>
