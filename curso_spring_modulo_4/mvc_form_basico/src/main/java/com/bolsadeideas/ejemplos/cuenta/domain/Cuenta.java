...
public class Cuenta {
	...
	// @NotEmpty es una anotación válida sólo para Strings. En cualquier otro tipo de objeto, se usa la anotación @NotNull
	...
	@Future // Valida que la fecha introducida sea una fecha futura o posterior a la fecha a actual
