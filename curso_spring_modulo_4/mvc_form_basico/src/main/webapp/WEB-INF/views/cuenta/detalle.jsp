...
<body>
	...
	<div class="container">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">Resultado datos enviados formato form</div>
			...
			de la clase controladora "CuentaController". -->
						<form:form modelAttribute="cuenta" action="${cuenta.id}" method="get"
							cssClass="form-horizontal" role="form">
							<div class="form-group">
								<form:label for="nombre" path="nombre"
									cssClass="col-sm-2 control-label">Nombre</form:label>
								<div class="col-sm-10">
									<form:input path="nombre" style="width: 300px;" readonly="true" cssClass="form-control" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="saldo" style="width: 300px;" cssClass="form-control" readonly="true"/>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="nivelEndeudamiento" style="width: 300px;" cssClass="form-control" readonly="true"/>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="fechaRenovacion" style="width: 300px;" cssClass="form-control" readonly="true"/>
								</div>
							</div>
