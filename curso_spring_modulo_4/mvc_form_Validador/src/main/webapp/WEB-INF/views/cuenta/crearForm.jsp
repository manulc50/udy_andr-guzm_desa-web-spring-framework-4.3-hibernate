...
<title>mvc_form_Validador</title>
<!-- Bootstrap -->
<link rel="stylesheet"
...
<body>
	...
	<div class="container">
		...
		<div class="page-header">
			<h1>
				Ejemplo InitBinder y Validación usando clase CuentaValidator <small>Crear
					Cuenta - Probar el validador: ingrese una fecha de renovación en
					tiempo pasado (ejemplo 03/04/15) para forzar el error.</small>
			</h1>
		</div>
